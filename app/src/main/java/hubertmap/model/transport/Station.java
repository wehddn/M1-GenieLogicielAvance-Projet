/**
 * This class represents a station in a transportation system.
 * A station has a name, coordinates (x and y), and a list of all transportation lines that serve it.
 */
...
/**
 * Constructs a new station with the given name, list of lines, and coordinates.
 * If the list of lines is null, an empty list is created.
 *
...
/**
 * Constructs a new station with the given name, line, and coordinates.
 * The station is served by only one transportation line.
 *
 * @param Name the name of the station
...
/**
 * Determines whether this station is equal to the specified station.
 * Two stations are considered equal if they have the same name and location.
 *
